    ...
    importTextbox(node) {
        ...
        if (paragraphsNode) {
            ...
            if (paraStyle) {
              ...
              // Find the <Format> tag within the first TextRun's style and set it.
        const formatNode = this.getNode('def:Paragraph/def:TextRuns/def:TextRun/def:Style/def:Format', paragraphsNode);
        if (formatNode) {
            textbox.format = formatNode.textContent;
        }
